...
const checkProfileComplete = async (req, res, next) => {
    try {
        ...
        const [personalInfo, experience, education, summary, jobPreference, language, projects, skills] = await Promise.all([
        ...
        if (
            ...
            return res.status(400).json({ message: "Please create a complete profile before applying for jobs." });
        }
